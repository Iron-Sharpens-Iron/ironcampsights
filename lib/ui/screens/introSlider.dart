...
class GettingStartedScreenState extends State<IntroSliderScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(automaticallyImplyLeading: false, centerTitle: false, actions: [setSkipButton()], title: Text("Intro")),
  ...
  appbar() {
    return AppBar(automaticallyImplyLeading: false, centerTitle: false, actions: [setSkipButton()], title: Text("Intro"));
  }
